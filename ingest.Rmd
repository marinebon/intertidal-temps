...
dir_p2p_robo <-
  case_when(
    ...
    user == "cdobbelaere" ~ here::here("robomussels/Robolimpets"))
    # user == "cdobbelaere" ~ here::here("robomussels/Robolimpets/Data/Argentina/Gregorio/data"))

  
# something going wrong here... can't find the files
list.files(
  dir_p2p_robo, ".*\\.csv$", 
